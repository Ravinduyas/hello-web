  ...
  const categories = [
    {
      ...
      image: asset('/fleet/tvs-ntorq-front.jpg'),
    ...
    },
    {
      ...
      alt: 'A Bajaj Pulsar manual motorbike from the Hello Rent fleet',
    },
    {
      name: 'Three Wheelers',
      ...
      alt: 'A Bajaj RE tuk-tuk parked under the Hello Rent sign in Weligama',
    },
    {
      name: 'Cars & Vans',
